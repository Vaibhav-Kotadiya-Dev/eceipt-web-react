...
const ZDraggableDoProductList = ({ items, onDragEnd, onChange, onRemove }) => {
                                                ...
                                                <Grid container sx={{ p: 0 }} >
                                                    ...
                                                    <Grid item xs={7} sx={{ pb: 1 }}>
                                                        <Grid container justifyContent="space-between" alignItems="center" sx={{ mb: 0 }}
                                                            flexDirection={{ xs: 'column', sm: 'row' }}>
                                                            {/* <Grid item> */}
                                                            <Typography display="inline" variant="h5">{t("remarks")+':'}  &nbsp;</Typography>
                                                            {/* </Grid>
                                                            <Grid item sx={{ flex: 1 }}> */}
...
export default ZDraggableDoProductList;